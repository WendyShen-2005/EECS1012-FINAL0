...
app.post('/post', (req, res) => {
    ...
    } else if(queryInfo['action'] == 'getUsername'){
...
app.get('/saveDraft', (req, res) => {
    ...
    try {
        fs1.readFile('profiles-list.json', "utf8", function readFileCallback(err, data) {
            if (err) {throw err;}
            else {
                ...
                fs1.writeFile('profiles-list.json', json, 'utf8', function (err) {
                    if (err) throw err;
...
app.get('/saveContact', (req, res) => {
    ...
    try { 
        fs1.readFile('contactList.json', "utf8", function readFileCallback(err, data) {
            if (err) {throw err;} 
            else {
...
app.post('/api/upload', upload1.single('bgImg'), (req, res) => {
